...
class IOAICertificateGeneratorV2:
    ...
    def _find_and_replace_text_enhanced(self, page: fitz.Page, old_text: str, new_text: str) -> bool:
        """
        Enhanced find and replace that preserves original text formatting
        ...
        try:
            ...
            logger.error(f"Error in enhanced text replacement for '{old_text}': {e}")
            return False
    ...
    def generate_certificate(self, participant_data: Dict) -> str:
        ...
        try:
            ...
            for page_num in range(len(doc)):
                ...
                # Replace placeholders with enhanced method
